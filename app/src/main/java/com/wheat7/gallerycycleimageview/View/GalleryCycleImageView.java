package com.wheat7.gallerycycleimageview.View;
...
import com.wheat7.gallerycycleimageview.R;
...
public class GalleryCycleImageView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        RelativeLayout.LayoutParams params = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, viewPagerHeight);
